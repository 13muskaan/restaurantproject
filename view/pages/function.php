...
<body>
	...
	<button class="accordion" style="text-align: center;">Anniverary</button>
	<div class="panel">
		<p style="text-align: center;">Celebrate your special day with us.</p>
	...
	<button class="accordion" style="text-align: center;">Birthday</button>
	<div class="panel">
		<p style="text-align: center;">Enjoy your birthday with us.</p>
	...
	<button class="accordion" style="text-align: center;">Corporate</button>
	<div class="panel">
		<p style="text-align: center;">Celebrate your office achievements with us.</p>
