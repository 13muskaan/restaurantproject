            ...
            <table class="table">
              ...
              <div id="buttons" align="center";>
                  ...
                  <p style="text-align: center;"> Or give us a call and we can deliver at your home.</p>
                      ...
                      <ul class="list-inline" style="padding:20px;">
      <li class="list-inline-item">                      <!--Deliveroo-->
                                       <form style="background-color:white;border:solid white;"><a href="https://deliveroo.com.au/menu/brisbane/teneriffe/my-banyan-tree?day=today&time=ASAP"> <button> <img src="../img/deliveroo.png" style="background-repeat:no-repeat; height:40px;"></a></button></form></li>
      <li class="list-inline-item">                     <!--Menulog-->
                      <form><a href="https://www.menulog.com.au/restaurants-my-banyan-tree/menu"><button> <img src="../img/menulog.png" style="background-repeat:no-repeat; height:40px;"></a></button></form></li>
      <li class="list-inline-item">                      <!--Eatnow-->
            <form><a href="https://www.eatnow.com.au/restaurant-7531/My-Banyan-Tree.html"> <button> <img src="../img/eatnow.jpg" style="background-repeat:no-repeat; height:40px;"></a></button></form></li>
