...
<head><title>MY BANYAN TREE | HOME </title>
	<style>
	.center {
    display: block;
    margin-left: auto;
...
<div id="body" style="width: 100%;"><form>
<div class="counter" style="text-align: right; padding-right: 25px;"><p><button class="btn btn-primary" href="reservation.php" style="width:auto;">Book Now</button><span class="glyphicon glyphicon-earphone one" style="width:50px;"></span> (07) 3358 3006 & (07) 3358 4006</p></div></form>
